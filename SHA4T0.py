...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing SHANTO'
    else
        figlet SHANTO
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By SHA4TO \e[1;32mSpeedX \e[0m"
    else
        echo -e "\e[1;34mCreated BySHA4TO \e[1;34m"
        toilet -f mono12 -F border SpeedX
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Facebook: https://www.facebook.com/ITS.SHA4T0 \e[0m"
    echo -e "\e[4;32m   whatsapp: +8801818819771 \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of SHA4T0 for more stability."
    echo " "
}
...
do
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN SHA4T0 Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
